...
public class log extends javax.swing.JFrame {
    ...
    public log() {
        try {
            ...
            con1 = DriverManager.getConnection(url +"profile","root", "");     
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            con1 = DriverManager.getConnection("jdbc:mysql://localhost:3306/profile", "root", "");
            stmt = con1.createStatement();
            st1 = con1.createStatement();
            rs = stmt.executeQuery("SELECT * FROM cloud where name='" + uname + "'");
            while (rs.next())
            {
                if (pass.equals(rs.getString("password"))) {
                    JOptionPane.showMessageDialog(null, rs.getString("name") + " Login Succesfully");
